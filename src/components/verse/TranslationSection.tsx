...
export const TranslationSection = ({ english, korean1, baeJik, baeUu, oxfordKr, oxfordEn }: TranslationSectionProps) => (
    <section className="mb-8 sm:mb-10">
        ...
        <div className="mb-[var(--spacing-fluid-lg)]">
            ...
            <div className="mx-auto max-w-3xl space-y-[var(--spacing-fluid-sm)] px-3 sm:px-6 lg:max-w-none lg:px-6">
        ...
        {(baeJik || baeUu) && (
            <div className="mb-[var(--spacing-fluid-lg)]">
                ...
                <div className="mx-auto max-w-3xl space-y-[var(--spacing-fluid-md)] px-3 sm:px-6 lg:max-w-none lg:px-6">
                    {baeJik && (
                        <div>
