...
export const TranslationSection = ({
    ...
    <section className="mb-8 sm:mb-10">
        <div className="mb-5 flex items-center justify-center sm:mb-6">
            <span className="text-xs tracking-[8px] text-gold-muted/40 dark:text-gold-muted/30">•••</span>
        </div>
        ...
        <div className="mb-[var(--spacing-fluid-lg)]">
            ...
            <div className="mx-auto max-w-3xl space-y-[var(--spacing-fluid-sm)] px-3 sm:px-6">
                {english && (
                    <p className="font-sans text-[var(--font-size-base)] leading-relaxed text-text-primary whitespace-pre-line break-keep dark:text-dark-text-primary lg:text-[var(--font-size-lg)]">
                        {english}
                    </p>
                )}
                {korean1 && (
                    <p className="font-sans text-[var(--font-size-base)] font-medium leading-relaxed text-text-primary whitespace-pre-line break-keep dark:text-dark-text-primary lg:text-[var(--font-size-lg)]">
                        {korean1}
                    </p>
                )}
            </div>
        ...
        {(baeJik || baeUu) && (
            <div className="mb-[var(--spacing-fluid-lg)]">
                ...
                <div className="mx-auto max-w-3xl space-y-[var(--spacing-fluid-md)] px-3 sm:px-6">
                    {baeJik && (
                        <div>
                            <h3 className="mb-1.5 text-center font-sans text-[11px] font-bold uppercase tracking-widest text-gold-muted opacity-70 dark:text-gold-muted">
                                직역
                            </h3>
                            <p className="font-sans text-[var(--font-size-base)] font-medium leading-relaxed text-text-primary whitespace-pre-line break-keep dark:text-dark-text-primary lg:text-[var(--font-size-lg)]">
                                {baeJik}
