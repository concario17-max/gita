        ...
        {(baeJik || baeUu) && (
            <div className="mb-[var(--spacing-fluid-lg)]">
                ...
                <div className="mx-auto max-w-3xl space-y-[var(--spacing-fluid-md)] px-3 sm:px-6 lg:max-w-[52rem] lg:px-8">
                    {baeJik && (
                        <div>
                            <h3 className="mb-1.5 text-center font-sans text-[11px] font-bold uppercase tracking-widest text-gold-muted opacity-70 dark:text-gold-muted">吏곸뿭</h3>
                    ...
                    {baeUu && (
                        <div>
                            <h3 className="mb-1.5 text-center font-sans text-[11px] font-bold uppercase tracking-widest text-gold-muted opacity-70 dark:text-gold-muted">?섏뿭</h3>
