...
export const SutraContent = ({
    ...
    return (
        <>
            <section className="mx-auto mb-[var(--spacing-fluid-sm)] max-w-3xl px-4 text-center sm:px-6 lg:max-w-none lg:px-6">
            ...
            <section className="mx-auto mb-[var(--spacing-fluid-sm)] flex max-w-3xl flex-col items-center px-4 text-center sm:px-6 lg:max-w-none lg:px-6">
            ...
            {cleanPronunciationKr && (
                <section className="mx-auto mb-[var(--spacing-fluid-md)] max-w-3xl px-4 text-center sm:px-6 lg:max-w-none lg:px-6">
