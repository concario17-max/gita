...
export const SutraNavigation = ({
    ...
    <div className="mt-10 pb-[calc(1.5rem+env(safe-area-inset-bottom))] sm:pb-8 flex justify-center font-inter px-4 sm:px-0">
        <div className="flex items-center justify-between bg-white/40 dark:bg-dark-surface/40 backdrop-blur-md border border-gold-primary/20 dark:border-dark-border/50 rounded-full px-2 sm:px-3 py-1.5 shadow-sm min-w-[220px] sm:min-w-[200px] hover:shadow-md transition-shadow">
            <button
                onClick={onPrev}
                disabled={isPrevDisabled}
                className="p-3.5 sm:p-3 rounded-full hover:bg-gold-surface/50 dark:hover:bg-[#222] transition-colors disabled:opacity-30 disabled:cursor-not-allowed group text-[#5B7282] dark:text-dark-text-secondary active:scale-90"
            >
