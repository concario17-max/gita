...
export const AppShell = React.memo(
    ({ header, sidebar, rightPanel, floatingAction, children, isMobilePanelOpen = false }: AppShellProps) => {
        return (
                ...
                <div className="relative z-10 flex h-full flex-1 flex-col overflow-hidden">
                    ...
                    <div className="relative flex flex-1 overflow-hidden">
                        ...
                        <main
                            ...
                            className={`custom-scrollbar min-w-0 flex-1 ${isMobilePanelOpen ? 'touch-none overflow-hidden' : 'overflow-y-auto'}`}
                        >
                            {children}
                        </main>
                        {rightPanel}
