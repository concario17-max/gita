...
const verseOneFiveBlocks: CommentaryBlock[] = [
    ...
    {
        title: '🔑 핵심 키워드',
        paragraphs: ['치타 제어, 마음의 다섯 가지 상태, 고통과 쾌락, 주관적 통증, 직관적 지혜, 확신과 식별'],
    },
    {
        title: '🎭 마음의 상태와 감각의 종속',
        paragraphs: [
            '마음의 상태는 크게 다섯 가지로 나뉘며, 쾌락과 고통 같은 기본 감각에 종속돼.',
            '이 상태들은 우리에게 고통스럽거나 기쁘거나 아무렇지 않은 단일한 상태로 인식되지.',
        ],
    },
    {
